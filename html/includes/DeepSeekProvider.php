<?php
// html/includes/DeepSeekProvider.php
/**
 * Proveedor de traducción DeepSeek (API compatible con OpenAI Chat Completions).
 */
class DeepSeekProvider extends AbstractTranslationProvider
{
